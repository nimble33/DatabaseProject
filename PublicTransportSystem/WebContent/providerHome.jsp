...
<form action ="providerController" method ="post">
  ...
  <div class="btn-group" role="group">
   <a href="insertTransport.jsp" target="iframe"  style="text-decoration: none; color:white;"> <button type = "button" name="login" class="btn btn-info">Insert Transport</button></a>
  </div>
  <div class="btn-group" role="group">
    <a href="updateTransport.jsp" target="iframe" style="text-decoration: none; color:white;"><button type = "button" name="register" class="btn btn-info">Update Transport</button></a>
  </div>
   <div class="btn-group"  role="group">
